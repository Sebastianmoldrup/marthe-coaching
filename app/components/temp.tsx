...
const steps = [
  "Hva ønsker du hjelp med akkurat nå?",
  "Klar for å ta ditt første steg?",
  "Del kontaktinformasjonen din så vi kan komme i gang",
  "Du sendes videre til betalingsløsningen – nesten i mål!",
];

const goals = [
  "Gå ned i vekt, få mer energi og trives i kroppen min",
  "Bygge styrke og føle meg sterkere i hverdagen",
  "Skape en sunn, balansert livsstil jeg faktisk trives med",
];

const callToAction = [
  "Fortell meg mer først",
